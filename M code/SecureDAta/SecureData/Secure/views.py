...
def PatientLogin(request):
    if request.method == 'POST':
      ...
      strdata = '<table border=1 align=center width=100%><tr><th>Customer ID</th><th>Customer Name</th><th>Age</th><th>Details</th><th>Profile Date</th><th>Access Control</th><th>Gender</th><th>Contact No</th><th>Address</th><th>Block Chain Hashcode</th><th>Revenue</th></th></tr><tr>'
...
def PatientDataAccess(request):
    if request.method == 'POST':
      ...
      with open("session.txt", "r") as file:
          for line in file:
             user = line.strip('\n')
      strdata = '<table border=1 align=center width=100%><tr><th>Customer ID</th><th>Customer Name</th><th>Age</th><th>Details</th><th>Profile Date</th><th>Access Control</th><th>Gender</th><th>Contact No</th></th></tr><tr>'
      con = pymysql.connect(host='localhost',port = 3306,user = 'root', password = '', database = 'SecuringData',charset='utf8')
